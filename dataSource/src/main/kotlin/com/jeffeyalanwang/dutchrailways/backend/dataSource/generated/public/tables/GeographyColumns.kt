...
open class GeographyColumns(
     ...
     */
    override fun where(condition: Condition?): GeographyColumns = GeographyColumns(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): GeographyColumns = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): GeographyColumns = where(DSL.notExists(select))
}
