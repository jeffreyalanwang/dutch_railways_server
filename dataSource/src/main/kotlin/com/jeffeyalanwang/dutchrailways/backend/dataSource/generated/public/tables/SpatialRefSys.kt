...
open class SpatialRefSys(
     ...
     */
    override fun where(condition: Condition?): SpatialRefSys = SpatialRefSys(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): SpatialRefSys = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): SpatialRefSys = where(DSL.notExists(select))
}
