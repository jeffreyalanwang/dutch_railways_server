...
open class StDump(
     ...
     */
    constructor(): this(DSL.name("st_dump"), null)
    ...
    override fun `as`(alias: String): StDump = StDump(DSL.name(alias), this, parameters)
    override fun `as`(alias: Name): StDump = StDump(alias, this, parameters)
    override fun `as`(alias: Table<*>): StDump = StDump(alias.qualifiedName, this, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: String): StDump = StDump(DSL.name(name), null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Name): StDump = StDump(name, null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): StDump = StDump(name.qualifiedName, null, parameters)
    ...
    fun call(
          __1: Geometry?
    ): StDump = StDump(DSL.name("st_dump"), null, arrayOf(
