...
open class StDumpsegments(
    ...
    companion object {
         ...
         */
        val ST_DUMPSEGMENTS: StDumpsegments = StDumpsegments()
    }
     ...
     * Rename this table
     */
    override fun rename(name: String): StDumpsegments = StDumpsegments(DSL.name(name), null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Name): StDumpsegments = StDumpsegments(name, null, parameters)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): StDumpsegments = StDumpsegments(name.qualifiedName, null, parameters)
    ...
    fun call(
          __1: Geometry?
    ): StDumpsegments = StDumpsegments(DSL.name("st_dumpsegments"), null, arrayOf(
