...
import com.jeffeyalanwang.dutchrailways.backend.routeQuery.impl.rRaptor
...
class RRaptorTest {
    ...
    fun testRRaptorSameOriginAndDestination() {
        ...
        val range = parseTime("09:00")..parseTime("11:00")
    ...
    fun testRRaptorMultipleJourneysNoDomination() {
        ...
        val timeRange = parseTime("09:30")..parseTime("11:30")
